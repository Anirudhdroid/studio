 ...
 *
 * - askQuestion - A function that answers a user's question about the document.
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a legal expert. Please answer the user's question about the legal document.
